                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            ...
                            <center>
                                <div class="caption">
                                    <h3>Chateau Ste Michelle Sauvignon Blanc</h3>
                                    <p>Price: 60 RON</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            ...
                            <center>
                                <div class="caption">
                                    <h3>Moet Imperial Brut Champagne</h3>
                                    <p>Price: 200 RON</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
